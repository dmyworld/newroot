    ...
    public function action()
    {
        ...
        if ($ptype == 4) {
            ...
            if ($this->db->insert('geopos_invoices', $data)) {
                ...
                $product_pquick = $this->input->post('pquick');
                $product_pquick_code = $this->input->post('pdInqcode');
                $product_quick_code_alt = $this->input->post('product_quick_code');
                ...
                $product_quick_alt = $this->input->post('product_quick');
                $product_local_imported = $this->input->post('local_imported');
                $product_o_pquick = $this->input->post('o_pquick');
                ...
                if (is_array($pid)) {
                    foreach ($pid as $key => $value) {
                        ...
                        $data = array(
                            ...
                            'pquick_code' => !empty($product_pquick_code[$key]) ? $product_pquick_code[$key] : @$product_quick_code_alt[$key],
                            'pwith' => $product_pwith[$key],
                            'pthickness' => $product_thicknes[$key],
                            'sqft' => !empty($product_sqft[$key]) ? $product_sqft[$key] : @$product_quick_alt[$key],
                            'local_imported' => $product_local_imported[$key] ?? null,
                            'o_pquick' => $product_o_pquick[$key] ?? 0,
                            'group_id' => $product_group_id[$key] ?? 0
                        );
    ...
    public function editaction()
    {
        ...
        if ($ptype == 4) {
            ...
            if ($this->db->update('geopos_invoices', $data)) {
                ...
                $product_pwith = $this->input->post('product_pwith');
                $product_thicknes = $this->input->post('product_thicknes');
                $product_sqft = $this->input->post('product_sqft'); // From edit.php
                $product_quick_alt = $this->input->post('product_quick'); // From newinvoice_v2.php
                $product_local_imported = $this->input->post('local_imported');
                $product_o_pquick = $this->input->post('o_pquick');
                $product_group_id = $this->input->post('group_id');
                foreach ($pid as $key => $value) {
