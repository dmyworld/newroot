                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?= base_url('purchase/printinvoice2?id=' . $invoice['iid']); ?>"><?php echo $this->lang->line('Print') ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?= base_url('purchase/printinvoice2?id=' . $invoice['iid']); ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-xs-left">Quick</th>
<!--                                        <th class="text-xs-left">Quick</th>-->
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountFormat_general($row['pquick']) . '-' . $row['unit'] . '</td>    
            ...
            <div class="modal-body">
                <form class="payment">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="dtype" value="purchase_logs">
