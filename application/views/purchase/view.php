                    ...
                    <div class="">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <span
                                ...
                                <div class="dropdown-menu"><a href="#sendSMS" data-toggle="modal"
                                    ...
                                    <a href="#sendSMS" data-toggle="modal" data-remote="false"
                                      ...
                                      <a href="<?= base_url() . 'pos_invoices/purchaseedit?id=' . $invoice['iid'] ?>" class="btn btn-warning mb-1"><i
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?= base_url() . 'pos_invoices/purchase_printinvoice?id=' . $invoice['iid'] ?>"><?php echo $this->lang->line('Print') ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?= base_url() . 'pos_invoices/purchase_printinvoice?id=' . $invoice['iid']; ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?= base_url() . 'invoices/purchase_delivery?id=' . $invoice['iid']; ?>"><?php echo $this->lang->line('Delivery Note') ?></a>
