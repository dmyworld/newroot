            ...
            <div id="invoice-template" class="card-body">
                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        <h2>Trunks Processing</h2>
                        <p class="pb-1">ID: <?php echo  $invoice['tid'] . '</p>
                ...
                <div id="invoice-customer-details" class="row pt-2">
                    <div class="col-sm-12 text-xs-center text-md-left">
                        <p class="text-muted">Processing Worker From</p>
                    </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-xs-left">Raund</th>
                                        <th class="text-xs-left">Lenth</th>
                                        <th class="text-xs-left">Cubic Feet</th>
                                    ...
                                    foreach ($products as $row) {
                                        $sub_t += $row['price'] * $row['pquick'];
                                        echo '<tr>
<th scope="row">' . $c . '</th>
                            <td>' . $row['product'] .' (Raund-'.$row['pwith'] .'-X-Lenth-'.$row['pthickness'] . ')</td>                           
                             
                             <td>' . amountFormat_general($row['qty']) .  '</td>
                            <td>' . amountFormat_general($row['pwith']) . '</td>
                            <td>' . amountFormat_general($row['pthickness']) . '</td>
                            <td>' . amountFormat_general($row['pquick']) . '</td>     
                        ...
                        <div class="col-md-5 col-sm-12">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="text-bold-800">Worker Salary:</td>
                                        <td class="text-bold-800 text-xs-right"> <?php echo amountExchange($invoice['total'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    
                                     <tr>
                                        <td class="text-bold-800">Cubic Feet Total:</td>
                                        <td class="text-bold-800 text-xs-right"><?php echo amountFormat_general($invoice['pquick'], 0, $this->aauth->get_user()->loc) ?>  </td>
                                    </tr>
                                                                         <tr>
                                        <td class="text-bold-800">Wood Cubic Total:</td>
                                        <td class="text-bold-800 text-xs-right"><?php echo amountFormat_general($invoice['wquick'], 0, $this->aauth->get_user()->loc) ?>  </td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-800">Cubic Wastage Total:</td>
                                        <td class="text-bold-800 text-xs-right"><?php echo amountFormat_general($invoice['quickwastage'], 0, $this->aauth->get_user()->loc) ?>  </td>
                                    </tr>
                ...
                <form class="payment">
                    ...
                    <div class="row">
                        <div class="col mb-1"><label
                            ...
                            <input type="text" class="form-control"
                                   ...
                                   value="Payment for Worker Salary #<?php echo $invoice['tid'] ?>"></div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                                id="purchasepayment_wood"><?php echo $this->lang->line('Do Payment') ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<div id="cancel_bill" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"> Cancel Worker Salary</h4>
            </div>
            <div class="modal-body">
