<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Trunks Processing<a
                        href="<?php echo base_url('purchase/newprocessing') ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="action-url" value="purchase/delete_i_wood">
        ...
        $(document).ready(function () {
            ...
            function draw_data(start_date = '', end_date = '') {
                $('#po').DataTable({
                    ...
                    'order': [],
                    'ajax': {
                        'url': "<?php echo site_url('purchase/ajax_list_wood')?>",
                        'type': 'POST',
                        'data': {
