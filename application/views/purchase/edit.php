...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#categories').on('change', function() {
            var cid = $(this).val();
            var wid = $('#warehouses option:selected').val();
            
            // Load subcategories for the selected category
            $.ajax({
                url: baseurl + 'search_products/get_sub_categories',
                dataType: 'html',
                method: 'POST',
            ...
            $.ajax({
                ...
                dataType: 'html',
                method: 'POST',
                data: 'cid=' + cid + '&wid=' + wid + '&' + crsf_token + '=' + crsf_hash,
                success: function(data) {
                    $('#pos_item').html(data);
                }
            });
        ...
        // Subcategory dropdown change handler
        $('#sub_categories').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'html',
                method: 'POST',
                data: 'cid=' + cid + '&sub_id=' + sub_id + '&wid=' + wid + '&' + crsf_token + '=' + crsf_hash,
                success: function(data) {
                    $('#pos_item').html(data);
                }
            });
        ...
        // Warehouse dropdown change handler
        $('#warehouses').on('change', function() {
            var wid = $(this).val();
            var cid = $('#categories').val();
            var sub_id = $('#sub_categories').val();
        ...
        // Search bar input handler with debouncing
        var searchTimer;
        $('#search_bar').on('keyup', function() {
            ...
            searchTimer = setTimeout(function() {
                $.ajax({
                    ...
                    dataType: 'html',
                    method: 'POST',
                    data: 'name=' + search_text + '&cid=' + cid + '&sub_id=' + sub_id + '&wid=' + wid + '&' + crsf_token + '=' + crsf_hash,
                    success: function(data) {
                        $('#pos_item').html(data);
                    }
                });
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        Mousetrap.bind('alt+n', function () {
            window.location.href = "<?=base_url('pos_invoices/edit') ?>";
        });
