                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content border-left border-right border-bottom p-3 bg-white" id="guideTabContent">
                                <div class="tab-pane fade show active" id="eng" role="tabpanel">
                                    <h6 class="text-primary mt-2">How to Create a Purchase Order</h6>
                                    <ol>
                                        <li><strong>Select Supplier:</strong> Choose an existing supplier or add a new one.</li>
                                        <li><strong>Add Products:</strong> Search for items to order.</li>
                                        <li><strong>Update Stock:</strong> Choose 'Yes' to update stock immediately upon creation, or 'No' to update later when goods are received.</li>
                                        <li><strong>Payment Terms:</strong> Set payment expectations.</li>
                                        <li><strong>Status:</strong> Orders start as 'Pending' if stock is not updated immediately.</li>
                                    </ol>
                                    <p class="text-muted"><small><strong>Note:</strong> Inventory is updated only when the order status is marked as 'Received' or if you select 'Update Stock: Yes'.</small></p>
                                </div>
                                <div class="tab-pane fade" id="sin" role="tabpanel">
                                    <h6 class="text-primary mt-2">මිලදී ගැනීමේ ඇණවුමක් (Purchase Order) සකසන ආකාරය</h6>
                                    <ol>
                                        <li><strong>සැපයුම්කරු තෝරන්න:</strong> පවතින සැපයුම්කරුවෙකු තෝරන්න හෝ අලුතින් එක් කරන්න.</li>
                                        <li><strong>නිෂ්පාදන එකතු කරන්න:</strong> ඇණවුම් කිරීමට අවශ්‍ය අයිතම සොයන්න.</li>
                                        <li><strong>තොග යාවත්කාලීන කිරීම:</strong> සාදන විටම තොග යාවත්කාලීන කිරීමට 'Yes' තෝරන්න, නැතහොත් භාණ්ඩ ලැබුණු පසු යාවත්කාලීන කිරීමට 'No' තෝරන්න.</li>
                                        <li><strong>ගෙවීම් කොන්දේසි:</strong> ගෙවීම් බලාපොරොත්තු සකසන්න.</li>
                                        <li><strong>තත්ත්වය:</strong> තොග වහාම යාවත්කාලීන නොකළහොත් ඇණවුම් 'Pending' ලෙස ආරම්භ වේ.</li>
                                    </ol>
                                    <p class="text-muted"><small><strong>සටහන:</strong> තොග යාවත්කාලීන වන්නේ ඇණවුමේ තත්ත්වය 'Received' ලෙස සලකුණු කළ විට හෝ ඔබ 'Update Stock: Yes' තෝරා ගත් විට පමණි.</small></p>
                                </div>
                                <div class="tab-pane fade" id="tam" role="tabpanel">
                                    <h6 class="text-primary mt-2">கொள்முதல் ஆர்டரை (Purchase Order) எவ்வாறு உருவாக்குவது</h6>
                                    <ol>
                                        <li><strong>சப்ளையரைத் தேர்ந்தெடுக்கவும்:</strong> இருக்கும் சப்ளையரைத் தேர்வுசெய்யவும் அல்லது புதியவரைச் சேர்க்கவும்.</li>
                                        <li><strong>தயாரிப்புகளைச் சேர்த்தல்:</strong> ஆர்டர் செய்ய வேண்டிய பொருட்களைத் தேடவும்.</li>
                                        <li><strong>இருப்பு புதுப்பிப்பு:</strong> உருவாக்கும்போதே இருப்பைப் புதுப்பிக்க 'Yes' என்பதைத் தேர்ந்தெடுக்கவும், அல்லது பொருட்கள் வந்த பிறகு புதுப்பிக்க 'No' என்பதைத் தேர்ந்தெடுக்கவும்.</li>
                                        <li><strong>கட்டண விதிமுறைகள்:</strong> கட்டண எதிர்பார்ப்புகளை அமைக்கவும்.</li>
                                        <li><strong>நிலை:</strong> இருப்பு உடனடியாகப் புதுப்பிக்கப்படாவிட்டால் ஆர்டர்கள் 'Pending' ஆகத் தொடங்கும்.</li>
                                    </ol>
                                    <p class="text-muted"><small><strong>குறிப்பு:</strong> ஆர்டர் நிலை 'Received' எனக் குறிக்கப்படும்போது அல்லது 'Update Stock: Yes' என்பதைத் தேர்ந்தெடுக்கும்போது மட்டுமே இருப்பு புதுப்பிக்கப்படும்.</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                            <tr class="sub_c" style="display: table-row;">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><input type="text" class="form-control shipVal"
                                                                    ...
                                                                    placeholder="Value"
                                                                    name="purchasecreateshipping" autocomplete="off"
                                                                    onkeyup="billUpyog();">
