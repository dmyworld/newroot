        ...
        <div class="card-body">
            ...
            <p id="step1"><span id="ldBar" class="text-center"
                ...
                <button type="button"
                        ...
                        id="download_update" disabled><i class="fa fa-download"></i> &nbsp; Step 1. Check & Download Update
                </button>
            ...
            ></span><br>
                ...
                <button type="button"
                        ...
                        id="install_update" disabled><i class="fa fa-file-text"></i> &nbsp; 2. Update Files
                </button>
            </p>
            <p>
            <hr>
            ...
            ></span><br>
                ...
                <button type="button"
                        ...
                        id="db_update" disabled><i class="fa fa-stack"></i> &nbsp; 3. Update Database
                </button>
            </p>
            <?php // } ?>
        </div>
