<div class="content-body">
    <div class="card">
        ...
        <div class="card-content">
            ...
            <label class="col-sm-2 col-form-label"
                   for="intbal"><?php echo $this->lang->line('Do not change') ?> - Adjust Balance</label>

            <div class="col-sm-6">
                <input type="text" placeholder="Intial Balance" onkeypress="return isNumber(event)"
                       class="form-control margin-bottom required" name="adjustbal" value="<?php echo $account['lastbal'] ?>">
            </div>
                 </div>
                ...
                <?php if ($account['account_type'] == 'Equity') {
                    ...
                    <div class="form-group row ">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="balance"><?php echo $this->lang->line('Account') ?><?php echo $this->lang->line('Balance') ?></label>
