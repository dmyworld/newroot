...
<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border"
    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <?php
            if (true) { // Forced all access for horizontal sidebar ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>pos_invoices"
                                 ...
                                 <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>reports/sales"
                                                    data-toggle="dropdown">Sales Reports</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>chart/trending_products"
                                                    data-toggle="dropdown">Products Reports</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>chart/product_cat"
                                                    data-toggle="dropdown">Products Categories Reports</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>pos_invoices/quotecreate"
            ...
            <?php }
            if (true) { // Forced all access for horizontal sidebar (Stock) ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>pos_invoices/purchasecreate"
                         ...
                         <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-wind"></i>Stock Transfer</a>
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>products/stock_transfer"
                                                    data-toggle="dropdown">New Transfe</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>delivery"
                                                    data-toggle="dropdown">Manage Transfe </a>
                                </li>
            ...
            if (true) { ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                                class="ft-layers"></i><span>Production</span></a>
                    <ul class="dropdown-menu">
                        <!-- Master Data -->
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-settings"></i>Setup & Master Data</a>
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>wood_types" data-toggle="dropdown">Wood Types</a></li>
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>timber_grades" data-toggle="dropdown">Timber Grades</a></li>
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>machines" data-toggle="dropdown">Machines</a></li>
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>carpenter_skills" data-toggle="dropdown">Skills</a></li>
                            </ul>
                        </li>

                        <!-- Modules -->
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>production_schedule" data-toggle="dropdown"><i class="ft-calendar"></i> Planning</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>production_routes" data-toggle="dropdown"><i class="ft-map"></i> Routes</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>cutting_plan" data-toggle="dropdown"><i class="ft-scissors"></i> Cutting Plans</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>seasoning" data-toggle="dropdown"><i class="ft-thermometer"></i> Seasoning</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>work_orders" data-toggle="dropdown"><i class="ft-check-square"></i> Work Orders</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>quality_control" data-toggle="dropdown"><i class="ft-shield"></i> Quality Control</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>production_inventory" data-toggle="dropdown"><i class="ft-box"></i> WIP Inventory</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>production_costing" data-toggle="dropdown"><i class="ft-dollar-sign"></i> Costing</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>production_intelligence" data-toggle="dropdown"><i class="ft-activity"></i> AI Insights</a></li>
                        <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>production_maintenance" data-toggle="dropdown"><i class="ft-tool"></i> Maintenance</a></li>
                    </ul>
                </li>
            <?php } 
            ...
            if ($this->aauth->premission(9)) { // Using permission 9 (Employee/Manager) or 4 (Project) as placeholder, allowing access
                ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                                class="fa fa-gavel"></i><span>Carpentry</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>carpentry_dashboard"
                                            data-toggle="dropdown"><i class="fa fa-tachometer"></i> Dashboard</a>
                        </li>
                         <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-map-marker"></i> Job Sites</a>
                             <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>job_sites"
                                                    data-toggle="dropdown">Manage Job Sites</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-cubes"></i> Materials</a>
                             <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>project_stock/issue"
                                                    data-toggle="dropdown">Issue Stock to Project</a>
                                </li>
                            </ul>
                        </li>
                         <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-pie-chart"></i> Reports</a>
                             <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>carpentry_reports/profitability"
                                                    data-toggle="dropdown">Profitability Report</a>
                                </li>
                            </ul>
                        </li>
                         <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                             ...
                             <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>assetmanager"
                                                    data-toggle="dropdown">Manage Assets</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>assetmanager/add"
                                                    data-toggle="dropdown">Add Asset</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>payrollprocessing"
                                                    data-toggle="dropdown">Run Payroll</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>employeeloans"
                                                    data-toggle="dropdown">Loans & Advances</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>timesheets"
                                                    data-toggle="dropdown">Timesheets</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>payrollsettings"
                                                    data-toggle="dropdown">Payroll Settings</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url('payrollreport'); ?>"
                                                    data-toggle="dropdown">Reports</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url('payrollworkflow'); ?>"
                                                    data-toggle="dropdown">Approvals</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>payroll"
                                                    data-toggle="dropdown">Legacy Payroll</a>
                                </li>
                            </ul>
                        </li>
