                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content border-left border-right border-bottom p-3 bg-white" id="guideTabContent">
                            <div class="tab-pane fade show active" id="eng" role="tabpanel">
                                <h6 class="text-primary mt-2">How to Create a Stock Return (Supplier)</h6>
                                <ol>
                                    <li><strong>Select Supplier:</strong> Choose the supplier to return items to.</li>
                                    <li><strong>Add Items:</strong> Search and add items to be returned.</li>
                                    <li><strong>Update Stock:</strong> Ensure 'Yes' is selected for 'Update Stock' to deduct items from your inventory immediately.</li>
                                    <li><strong>Reason:</strong> Use the note section to specify the reason for return (damaged, expired, etc.).</li>
                                </ol>
                                <p class="text-muted"><small><strong>Note:</strong> This action will reduce your stock count if 'Update Stock' is enabled.</small></p>
                            </div>
                            <div class="tab-pane fade" id="sin" role="tabpanel">
                                <h6 class="text-primary mt-2">තොග නැවත යැවීමක් (Stock Return) සකසන ආකාරය</h6>
                                <ol>
                                    <li><strong>සැපයුම්කරු තෝරන්න:</strong> භාණ්ඩ නැවත යැවිය යුතු සැපයුම්කරු තෝරන්න.</li>
                                    <li><strong>අයිතම එකතු කරන්න:</strong> ආපසු යැවීමට අයිතම සොයා එකතු කරන්න.</li>
                                    <li><strong>තොග යාවත්කාලීන කිරීම:</strong> ඔබේ තොගයෙන් අයිතම අඩු කිරීමට 'Update Stock' සඳහා 'Yes' තෝරා ඇති බව තහවුරු කරගන්න.</li>
                                    <li><strong>හේතුව:</strong> ආපසු යැවීමට හේතුව (හානි වූ, කල් ඉකුත් වූ, ආදිය) සටහන් කොටසේ සඳහන් කරන්න.</li>
                                </ol>
                                <p class="text-muted"><small><strong>සටහන:</strong> 'Update Stock' සක්‍රීය කර ඇත්නම් මෙම ක්‍රියාව ඔබේ තොග ප්‍රමාණය අඩු කරනු ඇත.</small></p>
                            </div>
                            <div class="tab-pane fade" id="tam" role="tabpanel">
                                <h6 class="text-primary mt-2">பங்குத் திருப்பலை (Stock Return) எவ்வாறு உருவாக்குவது</h6>
                                <ol>
                                    <li><strong>சப்ளையரைத் தேர்ந்தெடுக்கவும்:</strong> பொருட்களைத் திருப்பி அனுப்ப வேண்டிய சப்ளையரைத் தேர்வுசெய்யவும்.</li>
                                    <li><strong>பொருட்களைச் சேர்த்தல்:</strong> திருப்பி அனுப்ப வேண்டிய பொருட்களைத் தேடிச் சேர்க்கவும்.</li>
                                    <li><strong>இருப்பு புதுப்பிப்பு:</strong> உங்கள் இருப்பிலிருந்து பொருட்களைக் கழிக்க 'Update Stock'-ல் 'Yes' தேர்ந்தெடுக்கப்பட்டுள்ளதை உறுதிப்படுத்தவும்.</li>
                                    <li><strong>காரணம்:</strong> திரும்பப் பெறுவதற்கான காரணத்தை (சேதமடைந்தவை, காலாவதியானவை போன்றவை) குறிப்புப் பிரிவில் குறிப்பிடவும்.</li>
                                </ol>
                                <p class="text-muted"><small><strong>குறிப்பு:</strong> 'Update Stock' இயக்கப்பட்டிருந்தால் இந்த நடவடிக்கை உங்கள் இருப்பு எண்ணிக்கையைக் குறைக்கும்.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
