    ...
    <div class="card-body">
        <div class="card-block"><h4>Automated Tasks & Cron Job Management </h4>
            ...
            <a
                    ...
                    class="btn btn-default card-title font-size-large  collapsed blue"><i
                        class="fa fa-plus-circle"></i>
                Owner Intelligence Engine (Nightly)</a>

            <div id="a10" role="tabpanel"
                 class="card-collapse collapse">
                <p>
                    <small>Run this nightly to update Risk Alerts, Staff Scores, and Business Health.
                    </small>
                </p>
                <pre class="card-block card">WGET <?php echo base_url('RiskEngine/run_nightly_check?token=' . $corn['cornkey']) ?></pre>
                <pre class="card-block card">GET <?php echo base_url('RiskEngine/run_nightly_check?token=' . $corn['cornkey']) ?></pre>
            </div>
