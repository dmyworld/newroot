                    ...
                    <div class="col-md-4 border-right border-right-grey">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo base_url('job_sites/index?cid=' . $details['id']) ?>"
                                   class="btn btn-amber btn-md mr-1 mb-1 btn-block btn-lighten-2"><i
                                            class="fa fa-map-marker"></i> Job Sites
                                </a>
