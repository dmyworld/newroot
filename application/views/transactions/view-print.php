...
<hr>
<table>
    <?php echo '<tr><td>' . $this->lang->line('Date') . ' : ' . dateformat($trans['date']) . '</td><td>Transaction ID : ' . prefix(5) . $trans['id'] . '</td><td> ' . $this->lang->line('Category') . ' : ' . $trans['cat'] . '</td>  <td> ............................. <br> Authorized Person </td></tr>'; ?>
</table>
