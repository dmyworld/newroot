                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="product_description[]" id="dpid-0" value="">
                                <input type="hidden" name="product_pwith[]" id="product_pwith-0" value="">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="6" align="right">
                                    <strong>Planing Chargrs:</strong></td>
