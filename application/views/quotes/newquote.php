                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content border-left border-right border-bottom p-3 bg-white" id="guideTabContent">
                            <div class="tab-pane fade show active" id="eng" role="tabpanel">
                                <h6 class="text-primary mt-2">How to Create a Quote</h6>
                                <ol>
                                    <li><strong>Client Selection:</strong> Choose an existing client or search for one.</li>
                                    <li><strong>Add Items:</strong> Search and add products to the quote. Adjust quantities and prices as needed.</li>
                                    <li><strong>Terms & Notes:</strong> Set payment terms and add any public notes for the client.</li>
                                    <li><strong>Finalize:</strong> Click 'Generate Quote' to save. This does NOT deduct stock.</li>
                                </ol>
                                <p class="text-muted"><small><strong>Note:</strong> Quotes are created with 'Pending' status. Stock is NOT deducted until the Quote is converted to an Invoice.</small></p>
                            </div>
                            <div class="tab-pane fade" id="sin" role="tabpanel">
                                <h6 class="text-primary mt-2">මිල ගණන් (Quote) සකසන ආකාරය</h6>
                                <ol>
                                    <li><strong>පාරිභෝගිකයා තෝරා ගැනීම:</strong> පවතින පාරිභෝගිකයෙකු තෝරන්න හෝ සොයන්න.</li>
                                    <li><strong>අයිතම එකතු කිරීම:</strong> නිෂ්පාදන සොයා Quote එකට එකතු කරන්න. ප්‍රමාණ සහ මිල ගණන් අවශ්‍ය පරිදි සකසන්න.</li>
                                    <li><strong>කොන්දේසි සහ සටහන්:</strong> ගෙවීම් කොන්දේසි සකසන්න සහ පාරිභෝගිකයා සඳහා පොදු සටහන් එක් කරන්න.</li>
                                    <li><strong>අවසන් කිරීම:</strong> සුරැකීමට 'Generate Quote' ක්ලික් කරන්න. මෙය තොග අඩු නොකරයි.</li>
                                </ol>
                                <p class="text-muted"><small><strong>සටහන:</strong> Quote එකක් 'Pending' ලෙස සෑදේ. එය ඉන්වොයිසියක් බවට පරිවර්තනය කරන තෙක් තොග අඩු නොවේ.</small></p>
                            </div>
                            <div class="tab-pane fade" id="tam" role="tabpanel">
                                <h6 class="text-primary mt-2">மேற்கோளை (Quote) எவ்வாறு உருவாக்குவது</h6>
                                <ol>
                                    <li><strong>வாடிக்கையாளர் தேர்வு:</strong> இருக்கும் வாடிக்கையாளரைத் தேர்வுசெய்யவும் அல்லது தேடவும்.</li>
                                    <li><strong>பொருட்களைச் சேர்த்தல்:</strong> தயாரிப்புகளைத் தேடி மேற்கோளில் சேர்க்கவும். அளவுகள் மற்றும் விலைகளை தேவைக்கேற்ப சரிசெய்யவும்.</li>
                                    <li><strong>விதிமுறைகள் மற்றும் குறிப்புகள்:</strong> கட்டண விதிமுறைகளை அமைத்து வாடிக்கையாளருக்கான குறிப்புகளைச் சேர்க்கவும்.</li>
                                    <li><strong>முடித்தல்:</strong> சேமிக்க 'Generate Quote' என்பதைக் கிளிக் செய்யவும். இது இருப்பைக் குறைக்காது.</li>
                                </ol>
                                <p class="text-muted"><small><strong>குறிப்பு:</strong> மேற்கோள்கள் 'Pending' நிலையில் உருவாக்கப்படுகின்றன. மேற்கோளை இன்வாய்ஸாக மாற்றும் வரை இருப்பு குறையாது.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="saman-row-pos" class="rqw mt-1">
                <div class="col p-mobile">
                    ...
                    <div class="row mt-1">
                     ...
                     <div class="row mt-1">
                        <div class="col-3">
                            <strong>Planing Chargrs</strong></div>
                        <div class="col-6"><input type="text" class="form-control planingVal"
                                                  onkeypress="return isNumber(event)"
                                                  placeholder="Value"
                      ...
                      <div class="row mt-1">
                        <div class="col-3">
                            <strong>Cutting/Sawing Chargers</strong></div>
                        <div class="col-6"><input type="text" class="form-control cuttingsawingVal"
                                                  onkeypress="return isNumber(event)"
                                                  placeholder="Value"
                    ...
                    <div class="row mt-1">
                        <div class="col-3">
                            <strong>Loading/Unloading Chargers</strong></div>
                        <div class="col-6"><input type="text" class="form-control loadingunloadingVal"
                                                  onkeypress="return isNumber(event)"
                                                  placeholder="Value"
                                ...
                                <div class="row mt-1">
                        <div class="col-3">
                            <strong>SSC Levy </strong></div>
                        <div class="col-6">
                                
                                <select class="form-control round">
     
      <option value="off" data-tformat="off"data-trate="0">off</option>
