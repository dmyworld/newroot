                ...
                <form method="post" id="data_form">
                    ...
                    <div class="row">
                        ...
                        <td><input type="text" class="form-control req amnt" name="product_qty[]" id="amount-' . $i . '"
                                   onkeypress="return isNumber(event)" onkeyup="calculateQuicktreatment(' . $i . '), rowTotal(' . $i . '), billUpyog()"
                        ...
                        <td><input type="text" class="form-control req prc" name="product_t[]" id="t-' . $i . '" onkeypress="return isNumber(event)" onkeyup="calculateQuicktreatment(' . $i . '), rowTotal(' . $i . '), billUpyog()" autocomplete="off" value="' . $row['product_des'] . '"></td>
                        <td><input type="text" class="form-control req prc" name="product_w[]" id="w-' . $i . '" onkeypress="return isNumber(event)" onkeyup="calculateQuicktreatment(' . $i . '), rowTotal(' . $i . '), billUpyog()" autocomplete="off" value="' . $row['pwith'] . '"></td>
                        <td><input type="text" class="form-control req prc" name="product_l[]" id="l-' . $i . '" onkeypress="return isNumber(event)" onkeyup="calculateQuicktreatment(' . $i . '), rowTotal(' . $i . '), billUpyog()" autocomplete="off" value="' . $row['pthickness'] . '"></td>
                        
                        <td><span class="currenty">' . $this->config->item('currency') . '</span>
                            <strong><span class="ttttlText" id="resultttr-' . $i . '">' . edit_amountExchange_s($row['subtotal'], $invoice['multi'], $this->aauth->get_user()->loc) . '</span></strong><br>
                                    <span class="currenty">ft&#179; :</span>
                                    <strong><span class="ttlTextt" id="resultttc-' . $i . '">' . $row['pquick'] . '</span></strong>
                            </td>
...
<button type="button" data-rowid="' . $i . '" class="btn-sm btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                        ...
                        <input type="hidden" class="ttInput" name="product_subtotal[]" id="totaltt1-' . $i . '" value="' . edit_amountExchange_s($row['subtotal'], $invoice['multi'], $this->aauth->get_user()->loc) . '">
                        <input type="hidden" class="pdIn" name="pid[]" id="pid-' . $i . '" value="' . $row['pid'] . '">
                             <input type="hidden" name="unit[]" id="unit-' . $i . '" value="' . $row['unit'] . '">
                                   ...
                                   <input type="hidden" class="ttInput" name="product_quick[]" id="totalquick-' . $i . '" value="' . $row['pquick'] . '">
                    </tr>';
                                    $i++;
                                } ?>
                        ...
                        <input type="hidden" value="<?php echo $i; ?>" name="counter" id="ganak5">
