...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['price'], 0, $this->aauth->get_user()->loc) . '</td>
                             <td>' . amountFormat_general($row['qty']) . ' <small>' . $row['unit'] .'</small></td>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo $this->lang->line('Description') ?></th>
                                        <th class="text-xs-left">Thickness</th>
                                        <th class="text-xs-left">Width</th>
                                        <th class="text-xs-left">Length</th>
                                        
                                        
                                        <th class="text-xs-left">Pcs</th>
                                        <th class="text-xs-left"><?php echo $this->lang->line('Qty') ?></th>
                                        <th class="text-xs-left"><?php echo $this->lang->line('Amount') ?></th>
                                    </tr>
                                    </thead>
...
<th scope="row">' . $c . '</th>
                            <td>' . $row['product'] . '</td>                           
                            <td>' . amountFormat_general($row['product_des']) . '</td>
                            <td>' . amountFormat_general($row['pwith']) . '</td>
                            <td>' . amountFormat_general($row['pthickness']) . '</td>
                             
                            <td>' . amountFormat_general($row['qty']), $this->aauth->get_user()->loc . '</td>
                             <td>' . amountFormat_general($row['pquick']) . ' <small>' . $row['unit'] .'</small></td>                            
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                        </tr>';
