...
<div class="invoice-box">
    ...
    <table class="plist" cellpadding="0" cellspacing="0">
        <?php if ($r_type < 3) { ?>
            ...
            foreach ($report as $row) {
               ...
               // $linear_feet = $row['qty'] * $row['product_des'];
                
                $total_linear_feet += $row['qty'] * $row['product_des'];
                

                echo '<tr class="item' . $flag . '"><td>' . $row['product'] . '</td><td>' . $row['invoicedate'] . '</td><td>' . amountFormat_general($row['qty']) . '</td><td>' . amountExchange($row['price'], 0, $this->aauth->get_user()->loc) . '</td><td>' . $row['tid'] . '</td><td>' . $balance . '</td></tr>';
                $fill = !$fill;
            }
        } else {
            ?>
            ...
            foreach ($report as $row) {
                ...
                echo '<tr class="item' . $flag . '"><td>' . $row['product'] . '</td><td>' . $row['invoicedate'] . '</td><td>' . amountFormat_general($row['qty']) . '</td><td>' . $row['note'] . '</td><td>' . $balance . '</td></tr>';
                $fill = !$fill;
                $in++;
    ...
    <table class="subtotal">
        ...
        <tbody>
        <tr>
            <td class="myco2" rowspan="4"><br><br><br>
        ...
        <tr>
            ...
            <td><?php echo $total_linear_feet; ?></td>
        </tr>
