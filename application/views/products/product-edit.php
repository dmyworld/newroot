                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6"><label class="col-form-label"
                            ...
                            <select id="sub_cat" name="sub_cat" class="form-control select-box" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="product_warehouse" class="form-control" disabled>
                                <?php
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <input type="text" name="new_fproduct_cost" class="form-control"
                                       placeholder="0.00" aria-describedby="sizing-addon1"
                                       onkeypress="return isNumber(event)"
                                       value="<?php echo edit_amountExchange_s($product['fproduct_cost'], 0, $this->aauth->get_user()->loc) ?>">
                            </div>
                        </div>
                    </div>                    
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label">Q Stock Units*</label>

                        <div class="col-sm-4">
                            <input type="text" placeholder="Total Items in stock"
                                   class="form-control margin-bottom required" name="product_qty2"
                                   onkeypress="return isNumber(event)"
                                   value="<?php echo amountFormat_general($product['qty2']) ?>">
                        </div>
                    </div>
                  ...
                  <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label">Local Or Imported</label>
                    ...
                    <div class="col-sm-2">
                        <input type="text" placeholder="Product Length Feet"
                               class="form-control margin-bottom required" name="product_desc" value="<?php echo $product['product_des'] ?>" disabled></input>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" placeholder="Product Width Inches"
                               class="form-control margin-bottom" name="product_width" value="<?php echo $product['pwith'] ?>" disabled></input>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" placeholder="Product Width Inches"
                               class="form-control margin-bottom" name="product_thickness" value="<?php echo $product['pthickness'] ?>" disabled></input>
                        
                    </div>
                    
                </div>
                    <input type="hidden" name="product_desc"  value="<?php echo $product['product_des'] ?>"><!-- comment -->
                    <input type="hidden" name="product_width"  value="<?php echo $product['pwith'] ?>"><!--</input> comment -->
                    <input type="hidden" name="product_thickness"  value="<?php echo $product['pthickness'] ?>"><!-- comment -->
                <div class="form-group row">

                    <label class="col-sm-2 col-form-label">Product Quick</label>

                    <div class="col-sm-2">
                        <input type="text" placeholder="Product Width Inches"
                               class="form-control margin-bottom required" name="product_quick" value="<?php echo $product['pquick'] ?>" disabled></input>
                 ...
                 <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="product_quick_code">Product Quick Code</label>

                        <div class="col-sm-6">
                            <input type="text" placeholder="Product Quick Code"
                                   class="form-control" name="product_quick_code"
                                   value="<?php echo $product['pquick_code'] ?>">
                        </div>
                    </div>
