...
#saman-row-pos {
    flex-grow: 1;
    overflow: hidden; /* Prevent container scroll, we scroll internal wrapper */
    display: flex;
    flex-direction: column;
    padding-right: 5px;
}
/* Ensure the inner column fills height */
#saman-row-pos .col {
    display: flex;
    flex-direction: column;
    height: 100%;
...
/* Footer stays fixed (auto height, no shrink) */
#pos-footer-fixed {
    flex-shrink: 0;
    overflow-y: auto; /* Allow footer small scroll if needed, or just visible */
    max-height: 50vh; /* Safety cap */
}
...
#pos_item {
    flex-grow: 1;
    overflow-y: auto; /* Scroll product grid */
    padding-right: 5px;
}
</style>
<form method="post" id="data_form">
            ...
            <div id="saman-row-pos" class="rqw mt-1">
                <div class="col p-mobile">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong><?php echo $this->lang->line('Total Tax') ?></strong></div>
                                <div class="col-8">
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong><?php echo $this->lang->line('Total Discount') ?></strong></div>
                                <div class="col-8">
                                    <span class="currenty lightMode"><?php echo $this->config->item('currency');
                    ...
                    <div class="row mt-1">
                        <!-- Row 2: Transport & Planing -->
                        <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong>Transport</strong></div>
                                <div class="col-8">
                                    ...
                                    ( <?php echo $this->lang->line('Tax') ?> <?= $this->config->item('currency'); ?> <span id="ship_final">0</span> )
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong>Planing</strong></div>
                                <div class="col-8">
                                    <input type="text" class="form-control form-control-sm planingVal"
                                           onkeypress="return isNumber(event)" placeholder="Value"
                                           name="planing" autocomplete="off" onkeyup="billUpyog()">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-1">
                        <!-- Row 3: Cutting & Loading -->
                        <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong>Cutting</strong></div>
                                <div class="col-8">
                                    <input type="text" class="form-control form-control-sm cuttingsawingVal"
                                           onkeypress="return isNumber(event)" placeholder="Value"
                                           name="cuttingsawing" autocomplete="off" onkeyup="billUpyog()">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong>Loading</strong></div>
                                <div class="col-8">
                                    <input type="text" class="form-control form-control-sm loadingunloadingVal"
                                           onkeypress="return isNumber(event)" placeholder="Value"
                                           name="loadingunloading" autocomplete="off" onkeyup="billUpyog()">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-1">
                        <!-- Row 4: SSC & Extra Discount -->
                         <div class="col-6">
                            <div class="row">
                                <div class="col-4"><strong>SSC Levy</strong></div>
                                <div class="col-8">
                        ...
                        <div class="col-6">
                             <div class="row">
                                <div class="col-4"><strong><?php echo $this->lang->line('Extra') . ' ' . $this->lang->line('Discount') ?></strong></div>
                                <div class="col-8">
                                    <input type="text" class="form-control form-control-sm discVal"
                                           onkeypress="return isNumber(event)" placeholder="Value"
                                           name="disc_val" autocomplete="off" value="0" onkeyup="billUpyog()">
                                    <input type="hidden" value="0" name="after_disc" id="after_disc">
                                    ( <?= $this->config->item('currency'); ?> <span id="disc_final">0</span> )
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-1">
                    <div class="col-md-6 offset-md-6 text-right">
                        ...
                        <input type="text" name="total" class="form-control d-inline-block w-50 ml-1"
    ...
    <input type="hidden" value="pos_invoices/action_v2_new" id="action-url">
