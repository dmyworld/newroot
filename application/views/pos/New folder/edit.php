                    ...
                    <table id="pos_list" class="table-responsive tfr pos_stripe">
                        ...
                        foreach ($products as $row) {
                            ...
                            echo '<tr id="ppid-' . $i . '" class="mb-1">
                                ...
                                <td>
                                    <input type="text" class="form-control p-mobile req prc" name="product_price[]" id="rate-' . $i . '" onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $functionNum . '), billUpyog()" autocomplete="off" value="' . amountExchange_s($row['price'], $invoice['multi'], $this->aauth->get_user()->loc) . '">
                                </td>
                                <td>
                                ...
                                <input type="hidden" name="pquick[]" id="pquick-' . $i . '" value="' . $row['pquick'] . '">
                                <input type="hidden" name="product_quick_code[]" id="product_quick_code-' . $i . '" value="' . $row['pquick_code'] . '">
                                <input type="hidden" name="local_imported[]" id="local_imported-' . $i . '" value="' . $row['local_imported'] . '">
                                <input type="hidden" name="o_pquick[]" id="o_pquick-' . $i . '" value="' . ($row['o_pquick']) . '">
