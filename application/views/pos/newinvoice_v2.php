            ...
            <div id="saman-row-pos" class="rqw mt-1">
                        ...
                        <tfoot class="bg-white">
                            ...
                            <tr class="bg-lighten-5 border-top">
                                ...
                                <td colspan="3" class="p-1">
                                      <button type="button" class="btn btn-success btn-block shadow-sm font-weight-bold possubmit3 py-1" data-type="6" data-toggle="modal" data-target="#basicPay" style="font-size: 14px;">
                ...
                <ul class="nav nav-tabs" role="tablist" style="font-size: 11px;">
                    ...
                    <li class="nav-item">
                        ...
                        if ($id == 'v2'): ?>
                              <a class="btn btn-outline-danger btn-sm mr-1 mb-1 py-0 px-2" 
                                     href="<?php echo base_url('pos_invoices/create') ?>" role="tab" aria-selected="false"><i
                                    class="fa fa-save"></i>Go Back</a> 
                        <?php else: ?>
                              <a class="btn btn-outline-danger btn-sm mr-1 mb-1 py-0 px-2" 
                                     href="<?php echo base_url('pos_invoices/create?id=v2') ?>" role="tab" aria-selected="false"><i
                                    class="fa fa-save"></i>V2</a>
                        <?php endif; ?>
                    </li>
                    <li class="nav-item">
