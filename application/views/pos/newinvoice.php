            ...
            <div class="sidebar-content ">
                ...
                <div class="card-body chat-fixed-search">
                    ...
                    <div class="card bg-light border-light mb-2">
                        <div class="card-header font-weight-bold p-2" data-toggle="collapse" href="#helpGuide" role="button" aria-expanded="false" aria-controls="helpGuide" style="cursor: pointer;">
                            <i class="fa fa-book"></i> Help / උදව් / உதவி <i class="fa fa-angle-down float-right"></i>
                        </div>
                        <div class="collapse" id="helpGuide">
                            <div class="card-body p-2">
                                <ul class="nav nav-tabs" id="guideTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active small p-1" id="eng-tab" data-toggle="tab" href="#eng" role="tab">En</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link small p-1" id="sin-tab" data-toggle="tab" href="#sin" role="tab">සිං</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link small p-1" id="tam-tab" data-toggle="tab" href="#tam" role="tab">த</a>
                                    </li>
                                </ul>
                                <div class="tab-content border p-2 bg-white" id="guideTabContent">
                                    <div class="tab-pane fade show active" id="eng" role="tabpanel">
                                        <h6 class="text-primary mt-1 small">POS Detailed Guide</h6>
                                        <ol class="small pl-3 mb-0">
                                            <li><strong>Start Sale:</strong> Search Customer or keep default 'Walk In'.</li>
                                            <li><strong>Add Items:</strong> Scan barcode, type name in search, or selecting from Categories.</li>
                                            <li><strong>Adjust:</strong> Click item name to edit Qty/Price/Discount. Click Red 'X' to remove.</li>
                                            <li><strong>Options:</strong> Use Tabs for Coupons (Tab 1), Warehouse/Tax (Tab 2), or drafts (Tab 3).</li>
                                            <li><strong>Payment:</strong>
                                                <ul class="pl-3">
                                                    <li><span class="badge badge-success">Payment</span> Cash/Split/Bank options.</li>
                                                    <li><span class="badge badge-primary">Card</span> Quick Card Swipe.</li>
                                                    <li><span class="badge badge-warning">Draft</span> Suspend sale for later.</li>
                                                </ul>
                                            </li>
                                            <li><strong>Finish:</strong> Receipt prints automatically after payment.</li>
                                        </ol>
                                    </div>
                                    <div class="tab-pane fade" id="sin" role="tabpanel">
                                        <h6 class="text-primary mt-1 small">POS විස්තරාත්මක උපදෙස්</h6>
                                        <ol class="small pl-3 mb-0">
                                            <li><strong>විකිණීම අරඹන්න:</strong> පාරිභෝගිකයා සොයන්න හෝ 'Walk In' ලෙස තබන්න.</li>
                                            <li><strong>භාණ්ඩ එක් කරන්න:</strong> බාර්කෝඩ් ස්කෑන් කරන්න, නම සොයන්න, හෝ වර්ග (Categories) මගින් තෝරන්න.</li>
                                            <li><strong>වෙනස්කම්:</strong> ප්‍රමාණය/මිල වෙනස් කිරීමට අයිතමය ක්ලික් කරන්න. ඉවත් කිරීමට රතු 'X' ඔබන්න.</li>
                                            <li><strong>විකල්ප:</strong> කූපන් (Tab 1), ගබඩා (Tab 2), හෝ තාවකාලිකව නවතා තැබීමට Drafts (Tab 3) භාවිතා කරන්න.</li>
                                            <li><strong>ගෙවීම්:</strong>
                                                <ul class="pl-3">
                                                    <li><span class="badge badge-success">Payment</span> මුදල්/කාඩ්/බැංකු (Advanced).</li>
                                                    <li><span class="badge badge-primary">Card</span> ඉක්මන් කාඩ්පත් ගෙවීම්.</li>
                                                    <li><span class="badge badge-warning">Draft</span> පසුවට සුරකින්න.</li>
                                                </ul>
                                            </li>
                                            <li><strong>අවසන් කිරීම:</strong> ගෙවීමෙන් පසු රිසිට්පත ස්වයංක්‍රීයව මුද්‍රණය වේ.</li>
                                        </ol>
                                    </div>
                                    <div class="tab-pane fade" id="tam" role="tabpanel">
                                        <h6 class="text-primary mt-1 small">POS விரிவான வழிகாட்டி</h6>
                                        <ol class="small pl-3 mb-0">
                                            <li><strong>தொடங்கவும்:</strong> வாடிக்கையாளரைத் தேடவும் அல்லது 'Walk In' ஆக வைக்கவும்.</li>
                                            <li><strong>சேர்க்கவும்:</strong> பார்கோடு ஸ்கேன் செய்யவும், பெயரைத் தேடவும் அல்லது வகைகளைத் தேர்ந்தெடுக்கவும்.</li>
                                            <li><strong>மாற்றங்கள்:</strong> அளவு/விலையை மாற்ற பொருளை கிளிக் செய்யவும். அகற்ற சிவப்பு 'X' ஐ அழுத்தவும்.</li>
                                            <li><strong>விருப்பங்கள்:</strong> கூப்பன்கள் (Tab 1), கிடங்கு (Tab 2) அல்லது வரைவுகளுக்கு (Tab 3) தாவல்களைப் பயன்படுத்தவும்.</li>
                                            <li><strong>கட்டணம்:</strong>
                                                <ul class="pl-3">
                                                    <li><span class="badge badge-success">Payment</span> பணம்/அட்டை/வங்கி.</li>
                                                    <li><span class="badge badge-primary">Card</span> விரைவான அட்டை கட்டணம்.</li>
                                                    <li><span class="badge badge-warning">Draft</span> பின்னர் சேமிக்க (Suspend).</li>
                                                </ul>
                                            </li>
                                            <li><strong>முடித்தல்:</strong> ரசீது தானாகவே அச்சிடப்படும்.</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <div>
                    <div class="users-list-padding media-list">
						...
						<div class="row m-2">
                            <div class="col-3">
                                <strong>Planing Chargrs</strong>
                            </div>
                            <div class="col-3">
                                <input type="text" class="form-control form-control-sm planingVal"
                                       onkeypress="return isNumber(event)"
                                       placeholder="Value"
                                       name="planing" autocomplete="off"
                                       onkeyup="billUpyog()">
                            </div>
                            <div class="col-3">
                                ( <?php echo $this->lang->line('Tax') ?> <?= $this->config->item('currency'); ?>
                                <span id="planing_final">0</span> )
                            </div>
                        </div>
						...
						<div class="row m-2">
                            <div class="col-3">
                                <strong>Cutting/Sawing Chargers</strong>
                            </div>
                            <div class="col-3">
                                <input type="text" class="form-control form-control-sm cuttingsawingVal"
                                       onkeypress="return isNumber(event)"
                                       placeholder="Value"
                                       name="cuttingsawing" autocomplete="off"
                                       onkeyup="billUpyog()">
                            </div>
                            <div class="col-3">
                                ( <?php echo $this->lang->line('Tax') ?> <?= $this->config->item('currency'); ?>
                                <span id="cuttingsawing_final">0</span> )
                            </div>
                        </div>
                        ...
                        <div class="row m-2">
                            <div class="col-3">
                                <strong>Loading/Unloading Chargers</strong>
                            </div>
                            <div class="col-3">
                                <input type="text" class="form-control form-control-sm loadingunloadingVal"
                                       onkeypress="return isNumber(event)"
                                       placeholder="Value"
                                       name="loadingunloading" autocomplete="off"
                                       onkeyup="billUpyog()">
                            </div>
                            <div class="col-3">
                                ( <?php echo $this->lang->line('Tax') ?> <?= $this->config->item('currency'); ?>
                                <span id="loadingunloading_final">0</span> )
                            </div>
                        </div>
