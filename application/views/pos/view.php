                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?php echo 'printinvoice?id=' . $invoice['iid'] .'&id2='; ?>"><?php echo $this->lang->line('Print') ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                ...
                <div id="invoice-items-details" class="pt-2">
                    <div class="row">
                        <div class="table-responsive col-sm-12">
                            ...
                            <td>' . $row['code'] . '</td>
                            <td>';
                                    $unit_val = trim(strtolower($row['unit']));
                                    $show_rate = (isset($row['rate']) && $row['rate'] > 0) ? $row['rate'] : $row['price'];
                                    
                                    if ($unit_val == 'feet' || $unit_val == 'sqft' || $unit_val == 'sq.ft') {
                                       echo amountExchange($show_rate, 0, $this->aauth->get_user()->loc);
                                    } else {
                                        echo amountExchange($row['price'], 0, $this->aauth->get_user()->loc);
                                    }
                                    echo '</td>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                    ...
                                    foreach ($products as $row) {
                                       ...
                                       // $unit='feet'
                                            ...
                                            $unit=$row['unit'];
                                               ...
                                               echo '<tr>
                                                         <th scope="row">' . $c . '</th>
                                                          ...
                                                          <td>';
                                                          $show_rate = (isset($row['rate']) && $row['rate'] > 0) ? $row['rate'] : $row['price'];
                                                          echo amountExchange($show_rate, 0, $this->aauth->get_user()->loc) . '</td>
                                                           <td>' . amountFormat_general($row['qty']) . '</td>
                                                     <td>' ;
                                           ...
                                           if ( $unit === 'Feet' ) :
                                                  echo   amountFormat_s($sub_qty) . $row['unit']    ;
                                               else :
         
                                                   echo amountFormat_s($sub_qty2) . $row['unit']  ;
                                               endif;
                        ...
                        <div class="col-md-5 col-sm-12">
                            ...
                            <div class="table-responsive">
                                <table class="table">
									...
									<tr>
                                        <td>Planing Chargrs</td>
                                        <td class="text-xs-right"><?php echo amountExchange($invoice['planing'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
									<tr>
                                        <td>Cutting Chargrs </td>
                                        <td class="text-xs-right"><?php echo amountExchange($invoice['cuttingsawing'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
									<tr>
                                        <td>Loading Chargrs </td>
                                        <td class="text-xs-right"><?php echo amountExchange($invoice['loadingunloading'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="card-title text-timber-primary"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('Payment Confirmation') ?></h4>
            ...
            <div class="modal-body">
                <form class="payment">
                    <div class="row">
                        <div class="col-md-6">
                            <label><?php echo $this->lang->line('Total Amount') ?></label>
                        ...
                        <div class="col-md-6">
                             <label><?php echo $this->lang->line('Billing Date') ?></label>
                            <div class="input-group">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            <label for="shortnote"><?php echo $this->lang->line('Note') ?></label>
                            <input type="text" class="form-control" name="shortnote" placeholder="Short note" value="Payment for invoice #<?php echo $invoice['tid'] ?>">
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="smsbody" style="display: none;">
               ...
               <form method="post">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="mobile" name="mobile" 
                                           ...
                                           placeholder="94778387500" required
                                           pattern="94\d{9}" 
                        ...
                        <div class="col mb-1"><label
                                    for="shortnote"><?php echo $this->lang->line('Message'); ?></label>
                            <textarea class="form-control" name="message" id="sms_tem" title="Contents"
                                      rows="3"></textarea></div>
                    </div>
            ...
            <div class="modal-body">
                <form id="form_model">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-1"><label
                                    for="pmethod"><?php echo $this->lang->line('Mark As') ?></label>
                            <select name="hiding" class="form-control mb-1">
