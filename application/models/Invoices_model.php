...
class Invoices_model extends CI_Model
{
    ...
    {
        $this->db->select('geopos_purchase.*,SUM(geopos_purchase.shipping + geopos_purchase.ship_tax) AS shipping,geopos_supplier.*,geopos_purchase.loc as loc,geopos_purchase.id AS iid,geopos_supplier.id AS cid,geopos_terms.id AS termid,geopos_terms.title AS termtit,geopos_terms.terms AS terms');
