...
class Sms_model extends CI_Model
{
    ...
    {
  require APPPATH . 'third_party/notify/autoload.php';
   

$api_instance = new NotifyLk\Api\SmsApi();
$user_id = $sms_service['key1']; // string | API User ID - Can be found in your settings page.
$api_key = $sms_service['key2']; // string | API Key - Can be found in your settings page.
$message = $text_message; // string | Text of the message. 320 chars max.
...
try {
    ...
    private function twilio0($mobile, $text_message, $flag)
    {
