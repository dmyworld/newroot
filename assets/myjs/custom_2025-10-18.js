...
function calculateQuicktreatment(rowNumber) {
   ...
   var product_w_inches = parseFloat($('#w-' + rowNumber).val()) || 0;
    ...
    var cubicFeet =  (product_w_inches * product_l_feet * product_t_inches) / 144;
    
    

    var productSubtotal = amount * price; // updated subtotal calculation
    
    

    $('#result2-' + rowNumber).text(cubicFeet.toFixed(2));
    $('#result1-' + rowNumber).text(productSubtotal.toFixed(2));
