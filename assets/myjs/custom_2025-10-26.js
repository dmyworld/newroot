...
function calculateQuicktreatment(rowNumber) {
    ...
    var product_l_feet = parseFloat($('#l-' + rowNumber).val()) || 0;
    ...
    var resulttt = cubicFeet; // cubic feet
    var productSubtotal = productInFeet * price; // updated subtotal calculation
    
    $('#result22-' + rowNumber).val(productInFeet.toFixed(2));
    $('#resulttt-' + rowNumber).text(cubicFeet.toFixed(2));
    
    $('#result-' + rowNumber).text(productSubtotal.toFixed(2));
...
// If there's a discount, calculate it
    ...
    var grandTotaltimbert = productTotal + shippingTotal + planningTotal + cuttingSawingTotal + loadingUnloadingTotal - out;
...
var rowTotal = function (numb) {
    ...
    var totalPrice = amountVal.toFixed(two_fixed) * priceVal * dpidVal;
