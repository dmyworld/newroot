...
class Subscriptions_model extends CI_Model
{
    ...
    public function invoice_details($id)
    {
        ...
        $this->db->select('geopos_invoices.*,geopos_invoices.id AS iid,geopos_customers.*,geopos_customers.id AS cid,geopos_terms.id AS termid,geopos_terms.title AS termtit,geopos_terms.terms AS terms');
